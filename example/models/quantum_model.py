...
from src.nn.engine.quantum import quantum_net
import torch
...
class Net(nn.Module):
    ...
    def __init__(self, num_classes=10, num_layers=None, num_qubits=None) -> None:
        ...
        self.qnn = qml.qnn.TorchLayer(quantum_net, {"weights": (num_layers, num_qubits)})
        self.fc4 = nn.Linear(num_qubits, num_classes)        

...
def main():
    ...
    he_backend.set_poly_modulus_degree(2**13)
    he_backend.set_coef_mod_bit([60, 40, 60] )
    ...
    print("Decrypted vector:", dencrypted_vector)
    ...
    print("Decrypted matrix:", dencrypted_matrix)
    ...
    print("Decrypted dot product:", dencrypted_vector)
    ...
    print("Decrypted dot matrix:", dencrypted_dot_matrix)
